#Arquivos e configurações necessárias para os notebooks.
#Checklist dos equipamentos.
##Windows 7
1. Atualizar para SP1
2. Instalar chrome
...
3. Baixar CADESimu 4
4. Criar atalho do CADESimu na área de trabalho
5. Instalar Veyon
6. Instalar Python 3.8
7. Instalar driver CP210x
8. Instalar driver CH340
9. Configurar Veyon
